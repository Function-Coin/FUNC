...
RESOURCES += src/qt/func.qrc src/qt/func_locale.qrc

TRANSLATIONS += src/qt/locale/func_bg.ts \
                src/qt/locale/func_de.ts \
                src/qt/locale/func_en.ts \
                src/qt/locale/func_es.ts \
                src/qt/locale/func_fi.ts \
                src/qt/locale/func_fr.ts \
                src/qt/locale/func_it.ts \
                src/qt/locale/func_ja.ts \
                src/qt/locale/func_pl.ts \
                src/qt/locale/func_pt.ts \
                src/qt/locale/func_ru.ts \
                src/qt/locale/func_sk.ts \
                src/qt/locale/func_sv.ts \
