...
from fake_stake.base_test import FUNC_FakeStakeTest

class zFUNCwrappedSerialsTest(FUNC_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zFUNCs..." % DENOM_TO_USE)
