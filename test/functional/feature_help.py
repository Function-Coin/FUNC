...
"""Verify that starting func with -h works as expected."""
import subprocess

from test_framework.test_framework import FuncTestFramework
from test_framework.util import assert_equal

class HelpTest(FuncTestFramework):
    ...
    def run_test(self):
        self.log.info("Start func with -? for help text")
        ...
        self.log.info("Start func with -version for version information")
