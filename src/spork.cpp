...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 FUNC
    ...
    MAKE_SPORK_DEF(SPORK_16_ZEROCOIN_MAINTENANCE_MODE,      1555092104ULL), // OFF
...
// FUNC: on startup load spork values from previous session if they exist in the sporkDB
