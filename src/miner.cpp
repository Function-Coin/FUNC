...
void BitcoinMiner(CWallet* pwallet, bool fProofOfStake)
{
    ...
    util::ThreadRename("func-miner");
    const Consensus::Params& consensus = Params().GetConsensus();
    CBlockIndex* pindexPr = GetChainTip();
    const bool fTimeV2 = !Params().IsRegTestNet() && consensus.IsTimeProtocolV2(pindexPr->nHeight+1);
    const int64_t nSpacingMillis = consensus.TargetSpacing(fTimeV2) * 1000;
