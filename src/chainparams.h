 ...
 * FUNC system. There are three: the main network on which people trade goods
...
public:
    ...
    int FuncBadBlockTime() const { return nFuncBadBlockTime; }
    int FuncBadBlocknBits() const { return nFuncBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nFuncBadBlockTime;
    unsigned int nFuncBadBlocknBits;
