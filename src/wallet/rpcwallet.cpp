...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    BOOST_FOREACH(const string& name_, keys) {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid FUNC address: ")+name_);
...
UniValue listmintedzerocoins(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    set<CMintMeta> setMints = pwalletMain->zfuncTracker->ListMints(true, fMatureOnly, true);
...
UniValue listzerocoinamounts(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    set<CMintMeta> setMints = pwalletMain->zfuncTracker->ListMints(true, true, true);
...
UniValue spendzerocoin(const UniValue& params, bool fHelp)
{
    ...
    return DoZfuncSpend(nAmount, fMintChange, fMinimizeChange, vMintsSelected, address_str);
}
...
extern UniValue DoZfuncSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str)
{
...
UniValue resetmintzerocoin(const UniValue& params, bool fHelp)
{
    ...
    set<CMintMeta> setMints = zfuncTracker->ListMints(false, false, true);
...
UniValue resetspentzerocoin(const UniValue& params, bool fHelp)
{
    ...
    CWalletDB walletdb(pwalletMain->strWalletFile);
    CzFUNCTracker* zfuncTracker = pwalletMain->zfuncTracker.get();
    set<CMintMeta> setMints = zfuncTracker->ListMints(false, false, false);
...
UniValue exportzerocoins(const UniValue& params, bool fHelp)
{
    ...
    CzFUNCTracker* zfuncTracker = pwalletMain->zfuncTracker.get();
    set<CMintMeta> setMints = zfuncTracker->ListMints(!fIncludeSpent, false, false);
