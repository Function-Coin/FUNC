...
enum WalletFeature {
    ...
    FEATURE_PRE_FUNC = 61000, // inherited version..
...
enum ZerocoinSpendStatus {
    ...
    ZFUNC_TXMINT_GENERAL = 9,                        // General errors in MintsToInputVectorPublicSpend
...
public:
    ...
    /// Get 10000 FUNC output and keys which can be used for the Masternode
    ...
    void doZFuncRescan(const CBlockIndex* pindex, const CBlock& block, std::set<uint256>& setAddedToWallet, const Consensus::Params& consensus, bool fCheckZFUNC);
    ...
    // zFUNC wallet
    CzFUNCWallet* zwalletMain{nullptr};
    std::unique_ptr<CzFUNCTracker> zfuncTracker{nullptr};
    void setZWallet(CzFUNCWallet* zwallet);
    CzFUNCWallet* getZWallet();
