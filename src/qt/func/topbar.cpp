...
#include "qt/func/topbar.h"
#include "qt/func/forms/ui_topbar.h"
#include "qt/func/lockunlock.h"
#include "qt/func/qtutils.h"
#include "qt/func/receivedialog.h"
#include "qt/func/loadingdialog.h"
...
TopBar::TopBar(FUNCGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopFunc}, "amount-small-topbar");
    setCssProperty({ui->labelAmountFunc}, "amount-topbar");
    setCssProperty({ui->labelPendingFunc, ui->labelImmatureFunc}, "amount-small-topbar");
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // FUNC Total
    QString totalFunc = GUIUtil::formatBalance(balance, nDisplayUnit);

    // FUNC
    // Top
    ui->labelAmountTopFunc->setText(totalFunc);
    // Expanded
    ui->labelAmountFunc->setText(totalFunc);
    ui->labelPendingFunc->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureFunc->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
