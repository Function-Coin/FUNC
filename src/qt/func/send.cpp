...
#include "qt/func/forms/ui_send.h"
#include "qt/func/addnewcontactdialog.h"
#include "qt/func/qtutils.h"
#include "qt/func/sendchangeaddressdialog.h"
#include "qt/func/optionbutton.h"
#include "qt/func/sendconfirmdialog.h"
#include "qt/func/myaddressrow.h"
#include "qt/func/guitransactionsutils.h"
...
SendWidget::SendWidget(FUNCGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-func");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination funcAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(funcAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(funcAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
