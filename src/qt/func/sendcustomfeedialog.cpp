...
#include "qt/func/sendcustomfeedialog.h"
#include "qt/func/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(FUNCGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &FUNCGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
