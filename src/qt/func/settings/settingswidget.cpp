...
#include "qt/func/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(FUNCGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &FUNCGUI::openFAQ);
