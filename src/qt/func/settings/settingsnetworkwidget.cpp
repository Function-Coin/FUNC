...
#include "qt/func/settings/settingsnetworkwidget.h"
#include "qt/func/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/func/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(FUNCGUI* _window, QWidget *parent) :
