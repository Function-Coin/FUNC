...
#include "qt/func/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(FUNCGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("FUNC_tx_csv_export(*.csv)") : tr("FUNC_addresses_csv_export(*.csv)"),
                                        nullptr);
