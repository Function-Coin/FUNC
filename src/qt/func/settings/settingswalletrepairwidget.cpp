...
#include "qt/func/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/func/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(FUNCGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to FUNCGUI::handleRestart()
