...
#include "qt/func/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/func/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(FUNCGUI* _window, QWidget *parent) :
