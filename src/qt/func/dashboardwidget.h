...
#include "qt/func/txviewholder.h"
...
#include "config/func-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalFunc = 0;
    qint64 totalZfunc = 0;
    QList<qreal> valuesFunc;
    QList<qreal> valueszFunc;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(FUNCGUI* _window);
    ~DashboardWidget();
