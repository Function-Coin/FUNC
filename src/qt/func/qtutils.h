...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, FUNCGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, FUNCGUI* gui, double posX = 3);
