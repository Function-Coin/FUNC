...
#include "qt/func/forms/ui_addresseswidget.h"
#include "qt/func/addresslabelrow.h"
#include "qt/func/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(FUNCGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination funcAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(funcAdd, label.toUtf8().constData(),
