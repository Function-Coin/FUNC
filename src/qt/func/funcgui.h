...
#ifndef FUNC_CORE_NEW_GUI_FUNCGUI_H
#define FUNC_CORE_NEW_GUI_FUNCGUI_H
...
#include "qt/func/navmenuwidget.h"
#include "qt/func/topbar.h"
#include "qt/func/dashboardwidget.h"
#include "qt/func/send.h"
#include "qt/func/receivewidget.h"
#include "qt/func/addresseswidget.h"
#include "qt/func/coldstakingwidget.h"
#include "qt/func/masternodeswidget.h"
#include "qt/func/snackbar.h"
#include "qt/func/settings/settingswidget.h"
...
/**
  FUNC GUI main class. This class represents the main window of the FUNC UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class FUNCGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit FUNCGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~FUNCGUI();
...
#endif //FUNC_CORE_NEW_GUI_FUNCGUI_H
