...
public:
    ...
    void setZFuncControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzFUNC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzFUNC_clicked();
    void on_pushButtonZFuncControl_clicked();
