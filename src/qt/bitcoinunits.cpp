...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(FUNC);
    unitlist.append(mFUNC);
    unitlist.append(uFUNC);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case FUNC:
        return QString("func");
    case mFUNC:
        return QString("mfunc");
    case uFUNC:
        return QString::fromUtf8("ufunc");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZfunc)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZFUNC)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZFUNC);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZFUNC)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZFUNC));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
