...
/** Utility functions used by the FUNC Qt UI.
 */
namespace GUIUtil
{
...
// Render FUNC addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZfunc = false);
...
// Parse "func:" URI into recipient object, return true on successful parsing
