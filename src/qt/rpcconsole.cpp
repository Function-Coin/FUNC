                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzFUNCPathCustom = GetArg("-zfuncbackuppath", "");
    ...
    if(!strzFUNCPathCustom.empty()) {
        ui->wallet_customzfuncbackuppath->setText(QString::fromStdString(strzFUNCPathCustom));
        ui->wallet_customzfuncbackuppath_label->setVisible(true);
        ui->wallet_customzfuncbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzFUNCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the FUNC RPC console.") + "<br>" +
