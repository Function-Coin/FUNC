...
bool ComputeNextStakeModifier(const CBlockIndex* pindexPrev, uint64_t& nStakeModifier, bool& fGeneratedStakeModifier)
{
    ...
    const bool fTimeV2 = !Params().IsRegTestNet() && consensus.IsTimeProtocolV2(pindexPrev->nHeight+1);
    vSortedByTimestamp.reserve(64 * MODIFIER_INTERVAL  / consensus.TargetSpacing(fTimeV2));
