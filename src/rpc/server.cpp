...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* FUNC features */
        {"func", "masternode", &masternode, true, true, false},
        {"func", "listmasternodes", &listmasternodes, true, true, false},
        {"func", "getmasternodecount", &getmasternodecount, true, true, false},
        {"func", "masternodeconnect", &masternodeconnect, true, true, false},
        {"func", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"func", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"func", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"func", "masternodecurrent", &masternodecurrent, true, true, false},
        {"func", "masternodedebug", &masternodedebug, true, true, false},
        {"func", "startmasternode", &startmasternode, true, true, false},
        {"func", "createmasternodekey", &createmasternodekey, true, true, false},
        {"func", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"func", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"func", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"func", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"func", "getmasternodescores", &getmasternodescores, true, true, false},
        {"func", "mnbudget", &mnbudget, true, true, false},
        {"func", "preparebudget", &preparebudget, true, true, false},
        {"func", "submitbudget", &submitbudget, true, true, false},
        {"func", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"func", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"func", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"func", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"func", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"func", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"func", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"func", "checkbudgets", &checkbudgets, true, true, false},
        {"func", "mnsync", &mnsync, true, true, false},
        {"func", "spork", &spork, true, true, false},
        {"func", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzfuncseed", &getzfuncseed, false, false, true},
        {"zerocoin", "setzfuncseed", &setzfuncseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzfunc", &searchdzfunc, false, false, true},
        {"zerocoin", "dzfuncstate", &dzfuncstate, false, false, true},
