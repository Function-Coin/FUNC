...
#ifndef FUNC_LEGACY_ZPOS_H
#define FUNC_LEGACY_ZPOS_H

#include "stakeinput.h"
#include "main.h"
#include "txdb.h"

class CLegacyZFuncStake : public CStakeInput
{
private:
    uint32_t nChecksum;
...
public:
    ...
    explicit CLegacyZFuncStake(const libzerocoin::CoinSpend& spend);
    bool InitFromTxIn(const CTxIn& txin) override;
    bool IsZFUNC() const override { return true; }
