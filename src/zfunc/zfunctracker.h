...
#ifndef FUNC_ZFUNCTRACKER_H
#define FUNC_ZFUNCTRACKER_H
...
public:
    CzFUNCTracker(std::string strWalletFile);
    ~CzFUNCTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzFUNCWallet* zFUNCWallet = NULL);
