...
#ifndef FUNC_ZFUNCWALLET_H
#define FUNC_ZFUNCWALLET_H
...
public:
    CzFUNCWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZFUNC(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZFUNC(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
