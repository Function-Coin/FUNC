...
unsigned int GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader* pblock)
{
    ...
    /* current difficulty formula, func - DarkGravity v3, written by Evan Duffield - evan@dashpay.io */
    ...
    if (consensus.NetworkUpgradeActive(pindexLast->nHeight + 1, Consensus::UPGRADE_POS)) {
        ...
        const int64_t& nTargetSpacing = consensus.TargetSpacing(fTimeV2);
    ...
    int64_t _nTargetTimespan = CountBlocks * consensus.TargetSpacing(fTimeV2);
