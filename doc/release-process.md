...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/Function-Coin/FUNC/blob/master/doc/translation_process.md#synchronising-translations).
* Update manpages, see [gen-manpages.sh](https://github.com/Function-Coin/func/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/Function-Coin/gitian.sigs.git
    git clone https://github.com/Function-Coin/func-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/Function-Coin/func.git
...
- Detached signatures will then be committed to the [func-detached-sigs](https://github.com/Function-Coin/func-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/Function-Coin/FUNC/releases/new) with a link to the archived release notes.
