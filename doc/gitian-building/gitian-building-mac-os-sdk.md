...
The script [extract-osx-sdk.sh](https://github.com/Function-Coin/func/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/Function-Coin/func/blob/master/doc/README_osx.md) for troubleshooting tips.