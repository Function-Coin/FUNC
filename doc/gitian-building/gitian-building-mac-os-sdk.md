...
The script [extract-osx-sdk.sh](https://github.com/CryptoDev-Project/func/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
func/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/CryptoDev-Project/func/blob/master/doc/README_osx.md) for troubleshooting tips.