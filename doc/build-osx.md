...
FUNC Core is now available at `./src/funcd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/FUNC"

    touch "/Users/${USER}/Library/Application Support/FUNC/func.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/FUNC/func.conf"

The first time you run funcd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/funcd -daemon # Starts the func daemon.
    ./src/func-cli --help # Outputs a list of command-line options.
    ./src/func-cli help # Outputs a list of RPC commands when the daemon is running.
