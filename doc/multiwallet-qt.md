...
In order to support loading of multiple wallets in func-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is func.cpp.
...
Changes to func.cpp
----------------------
func.cpp is the entry point into func-qt, and as such, will require some minor modifications to provide hooks for
