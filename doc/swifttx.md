...
This mechanism has been integrated into Bitcore-Node-FUNC which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/FunTimeDev/insight-api-func#web-socket-api](https://github.com/FunTimeDev/insight-api-func#web-socket-api) 
* API: [https://github.com/FunTimeDev/insight-api-func#swifttx-transactions](https://github.com/FunTimeDev/insight-api-func#swifttx-transactions) 
...
By default, the FUNC Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FUNC Core daemon:
