...
This issue tracker is only for technical issues related to FUNC Core.
General FUNC questions and/or support requests and are best directed to the [FUNC Discord](https://discord.func.org).
...
### What version of FUNC Core are you using?
