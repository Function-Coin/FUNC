Contributing to FUNC Core
============================

The FUNC Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/CryptoDev-Project/func/blob/master/doc/translation_process.md)
...
The following applies to code changes to the FUNC Core project, and is not to be
confused with overall FUNC Network Protocol consensus changes.

Whether a pull request is merged into FUNC Core rests with the project merge
...
Patches that change FUNC consensus rules are considerably more involved than
...
Where a patchset proposes to change the FUNC consensus, it must have been
...
The project leader is the release manager for each FUNC Core release.
